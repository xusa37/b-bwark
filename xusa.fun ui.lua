...
function AddWindow(options)
	...
	options = Library:validate({
		name = string.format('xusa.fun <font color="rgb(%d, %d, %d)">[v1.0]</font> | developed by source.lua', Library.Colors.Accent.R * 255, Library.Colors.Accent.G * 255, Library.Colors.Accent.B * 255),
